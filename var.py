...
# ─── Trade History / Watchlist Tickers ────────────────────────────────────────
TRADE_HISTORY_TICKERS = [
    "AKAM", "AME", "AMAT", "ADI", "APH", "APA", "BG", "BIIB", "BKR", "CAT",
    "CFG", "CHRW", "CIEN", "CME", "COP", "CSX", "CTRA", "CVX", "DE", "DVN",
    "EMR", "FANG", "FIX", "GILD", "GLW", "HAS", "HCA", "HUBB", "HWM", "IBKR",
    "JBL", "KEYS", "KMI", "LHX", "LMT", "LRCX", "LUV", "MU", "MPWR", "NEE",
    "NOC", "PKG", "PH", "PWR", "RTX", "SLB", "SNDK", "STX", "SWK", "TDY",
    "TER", "TRGP", "VTRS", "WAB", "WDC", "XOM",
]
...
def get_ticker_list(universe: str) -> list:
    ...
    elif universe == "Trade History":
        return sorted(TRADE_HISTORY_TICKERS)
    else:
        return []
